        ...
        <div className="grid gap-16 py-16 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted-foreground/80">
                La première plateforme de marché en ligne à Djibouti. Nous
                connectons les acheteurs et les vendeurs pour créer des
          ...
          >
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <FooterLink href="#">Tarification</FooterLink>
                </li>
                <li>
                  <FooterLink href="#">Programme VIP</FooterLink>
                </li>
                <li>
                  <FooterLink href="#">Devenir vendeur</FooterLink>
                </li>
              </ul>
            </div>
            <div>
          ...
          >
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <FooterLink href="#">Protection des données</FooterLink>
              </li>
              <li>
