                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                        ...
                        <div className="p-8 lg:p-12">
                            ...
                            <p className="mt-4 text-lg text-muted-foreground">
                                Rejoignez notre communauté de plus de 50,000 membres et recevez les meilleures offres directement dans votre boîte mail.
                            </p>
                            ...
                            <form onSubmit={handleSubmit} className="mt-8">
                                ...
                                {status.type && (
                                    <Alert className={`mt-4 ${status.type === "success" ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"
                                        }`}>
                            ...
                            <p className="mt-4 text-xs text-muted-foreground">
                                En vous inscrivant, vous acceptez de recevoir des emails marketing de Suuq.
