...
export function SearchCommand({ open: controlledOpen, onOpenChange, onSelect }: SearchCommandProps) {
    ...
    const [trendingItems] = useState<SearchResult[]>([
        {
            ...
            image: "https://images.unsplash.com/photo-1538688525198-9b88f6f53126?w=100&h=100&fit=crop",
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1558002038-1055907df827?w=100&h=100&fit=crop",
